...
monster_data = {
    "squid": {
        ...
        "damage": 20,
        "attack_type": "slash",
        "attack_sound": os.path.join(PROJECT_DIR, "../audio/attack/slash.wav"),
        "speed": 3,
        "resistance": 3,
        "attack_radius": 80,
        "notice_radius": 360,
    ...
    "raccoon": {
        ...
        "damage": 40,
        "attack_type": "claw",
        "attack_sound": os.path.join(PROJECT_DIR, "../audio/attack/claw.wav"),
        "speed": 2,
        "resistance": 3,
        "attack_radius": 120,
        "notice_radius": 400,
    ...
    "spirit": {
        ...
        "damage": 8,
        "attack_type": "thunder",
        "attack_sound": os.path.join(PROJECT_DIR, "../audio/attack/fireball.wav"),
        "speed": 4,
        "resistance": 3,
        "attack_radius": 60,
        "notice_radius": 350,
